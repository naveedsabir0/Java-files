/**
 * The {@code Test001} class serves as a test class to demonstrate the functionality of the DVLA (Driver and Vehicle Licensing Agency) system.
 * It creates instances of Address, Keeper, Car, and RegNo, adds them to a DVLA object, and displays information about all registered cars.
 */
public class Test001 {

    /**
     * The main method for testing the DVLA functionality.
     *
     * @param args The command-line arguments (not used in this context).
     */
    public static void main(String[] args) {
        // Creating DVLA instance
        DVLA dvla = new DVLA();
     ...
     // Creating cars with tax expiration months
        ...
        // Displaying all cars
        System.out.println("All Cars in DVLA Database:");
        dvla.showAllCars();
    }
}
