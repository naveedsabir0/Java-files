...
/**
 * The {@code Test002} class serves as a test class to demonstrate the functionality of the DVLA (Driver and Vehicle Licensing Agency) system
 * and showcases the use of TreeMap for sorting car registrations based on their registration numbers.
 */
public class Test002 {

    /**
     * The main method for testing the DVLA functionality and TreeMap sorting.
     *
    ...
    public static void main(String[] args) {
     ...
     // Creating cars with tax expiration months
        ...
        // Convert the DVLA HashMap to TreeMap
        Map<RegNo, Car> sortedMap = new TreeMap<>(dvla.getRegistrationInfoMap());

        // Verify the tree traversal is in sorted order
        System.out.println("Sorted Cars in DVLA Database:");
        for (Map.Entry<RegNo, Car> entry : sortedMap.entrySet()) {
